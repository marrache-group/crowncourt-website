...
const features = [
  {
    ...
    description:
      'Counter-clockwise for your points, clockwise for your opponent. Haptic feedback on every score change.',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Complete Scoring Engine',
    description:
      'Best of 1, 3, or 5 sets. Tiebreaks, deuce, advantage — all handled automatically.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'iOS Companion',
    description:
      'Match history, player profiles, and UTR ratings. Syncs seamlessly with your Watch.',
    icon: DeviceClockIcon,
  },
  {
    name: 'Always-On Display',
    description:
      'A dimmed score view stays visible when your wrist is down — always ready when you glance at your Watch.',
    icon: DeviceListIcon,
  },
  {
    name: 'HealthKit Integration',
    description:
      'Runs as a foreground workout session. Track tennis activity in Apple Health automatically.',
    icon: DeviceLockIcon,
  },
  {
    name: 'Offline Support',
    description:
      'Play without a connection. Matches sync to the cloud when you\'re back online.',
      ...
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Stop counting in your head. CrownCourt handles every point, game,
            and set so you can focus on your game.
          </p>
        </div>
        <ul
          role="list"
